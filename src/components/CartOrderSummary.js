    ...
    <div className="order-summary">
      ...
      <div className="order-shipping-costs">
        ...
        <div className="order-shipping-costs-price">
          {props.subtotalPrice >= 100 ? props.formatPriceValue(0) : props.formatPriceValue(props.shippingCosts)}
        </div>
      </div>
      ...
      <div className="order-estimated-total">
        ...
        <div className="order-estimated-total-price">
          {props.subtotalPrice >= 100 ? props.formatPriceValue(props.subtotalPrice) : props.formatPriceValue(props.subtotalPrice + props.shippingCosts)}
        </div>
      </div>
